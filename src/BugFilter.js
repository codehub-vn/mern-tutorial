...
var BugFilter = React.createClass({
  render: function() {
    ...
    return (
      <Panel collapsible defaultExpanded={true} header="Bộ Lọc">
        <Grid fluid={true}>
          <Row>
            <Col xs={12} sm={6} md={4}>
              <Input type="select" label="Mức Độ Ưu Tiên" value={this.state.priority}
            ...
            <Col xs={12} sm={6} md={4}>
              <Input type="select" label="Trạng Thái" value={this.state.status}
            ...
            <Col xs={12} sm={6} md={4}>
              <Input label="&nbsp;">
                <ButtonInput value="Tìm Kiếm" bsStyle="primary" onClick={this.submit} />
              </Input>
            </Col>
          </Row>
        </Grid>
